...
sudo -u standup /bin/mkdir /mnt/volume_nyc1_01/.bitcoin
...
cat >> /mnt/volume_nyc1_01/.bitcoin/bitcoin.conf << EOF
server=1
rpcuser=StandUp
rpcpassword=$RPCPASSWORD
rpcallowip=127.0.0.1
debug=tor
datadir=/mnt/volume_nyc1_01/.bitcoin
EOF
...
/bin/chown standup /mnt/volume_nyc1_01/.bitcoin/bitcoin.conf
/bin/chmod 600 /mnt/volume_nyc1_01/.bitcoin/bitcoin.conf
...
[Service]
ExecStart=/usr/local/bin/bitcoind -conf=/mnt/volume_nyc1_01/.bitcoin/bitcoin.conf
# Process management
####################
Type=simple
